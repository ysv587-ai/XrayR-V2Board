...
install_XrayR() {
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/ysv587-ai/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
    ...
    echo "Telegram: https://t.me/spcloud"
    echo "Github: https://github.com/ysv587-ai/XrayR-V2Board"
